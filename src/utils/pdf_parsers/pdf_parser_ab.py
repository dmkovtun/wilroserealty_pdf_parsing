...
class PdfParserAB(PdfParser):
    ...
    def schedule_ab_parsing_text_type_2(self, filename: str):
        ...
        all_text = ""
        for page_text in get_pdf_content_from_text_ocr(filename, crop_image, search_text=["54.", "55.", "Part 9"]):
            all_text += page_text
        ...
        try:
            ...
            if any(type4_artifacts):
                extracted_rows = self.parse_pdf_file(
                    filename, {"type4": self.schedule_ab_parsing_text_type_3}, discover_pdf_type_schedule_ab
                )
